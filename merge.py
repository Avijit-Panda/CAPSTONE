...
def alert():
     mixer.init()
     alert=mixer.Sound('C:\\Users\\BHARA\\Downloads\\ADHDZeroBlinkDetection-master\\ADHDZeroBlinkDetection-master\\beep-07.wav')
     alert.play()
     time.sleep(0.1)
     alert.play()
...
def initializeFiles(name,age):
    ...
    patientLog.truncate()
    print('Name:', name, file=patientLog)

    print('Age:', age, file=patientLog)


    patientTimeLog = open("patientBlinkTime.txt", 'w')
    patientTimeLog.truncate()
    print('Name:', name, file=patientTimeLog)

    print('Age:', age, file=patientTimeLog)
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def looping():
                ...
                face_cascade = cv2.CascadeClassifier("C:\\Users\\BHARA\\Downloads\\ADHDZeroBlinkDetection-master\\ADHDZeroBlinkDetection-master\\haarcascade_frontalface_default.xml")
                eye_cascade = cv2.CascadeClassifier("C:\\Users\\BHARA\\Downloads\\ADHDZeroBlinkDetection-master\\ADHDZeroBlinkDetection-master\\CustomBlinkCascade.xml")
                        ...
                        try:
                            ...
                            for (ex, ey, ew, eh) in eyes:
                                if ii < 1 and ey < (h * .33) and (total > blinkDetectionThreshold) and oneEyeDetected == False:
                                    ...
                                    print('Blink Detected', file=patientTimeLog)

                                    print('Blink Time:', strftime("%Y-%m-%d %H:%M:%S", gmtime()), file=patientTimeLog)
